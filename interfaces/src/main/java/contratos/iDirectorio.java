...
/**
 * Contrato para el "Libro de Direcciones" del servidor.
 * Su única responsabilidad es almacenar y proveer información
 * de conexión de los jugadores.
 *
...
public interface iDirectorio {
    ...
    /**
     * Interfaz simple para exponer los datos de conexión de un cliente
     * sin exponer la clase de implementación interna del Directorio.
     */

 ...
 * Define los métodos necesarios para crear y configurar la infraestructura de 
 * comunicación del lado del cliente (capas de envío y recepción).
 *
 * @author benja
 */
public interface iEnsambladorCliente {
    ...
    /**
     * Crea e inicializa el componente de envío de mensajes (Despachador) del cliente.
     *
     * @param ipServidor La IP del servidor de destino.
     * @param puertoServidor El puerto del servidor de destino.
     * @return Una instancia de {@link iDespachador} lista para enviar comandos al servidor.
     */
     ...
     * @param oyente La clase (normalmente el Modelo) que implementa PropertyChangeListener 

 ...
 * Es el ÚNICO componente en el servidor que conoce las Entidades.
 */
public class AgenteIniciarPartida {

    private Tablero tableroDeJuego;

    /**
     * Al ser creado, este agente instancia el dominio del juego
     * y crea el mazo completo.
     */
    public AgenteIniciarPartida() {
    ...
    /**
     * Método de ayuda para convertir de Entidad a DTO.
     * La Pizarra no sabe qué es una "Ficha", pero el cliente sí sabe
     * qué es una "FichaJuegoDTO".
     */
